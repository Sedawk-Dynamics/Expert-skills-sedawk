...
const courseData: Category[] = [
  {
    ...
    certifications: [
      ...
      },
      {
        ...
        whoCanLearn: ['Manual Testers', 'Agile Beginners', 'Scrum Team Members', 'Junior QA Engineers'],
      ...
      },
      {
        ...
        whoCanLearn: ['Automation Testers', 'Selenium Testers', 'Playwright Testers', 'API Automation Testers'],
      ...
      },
      {
        ...
        whoCanLearn: ['Manual Testers', 'Test Analysts', 'QA Engineers', 'Functional Testers'],
      ...
      },
      {
        ...
        whoCanLearn: ['Performance Testing Beginners', 'Manual Testers moving to Performance', 'Automation Testers', 'QA Engineers'],
      ...
      },
      {
        ...
        whoCanLearn: ['QA Engineers', 'Security Testing Beginners', 'Manual Testers', 'Automation Testers'],
    ...
    certifications: [
      {
        ...
        whoCanLearn: ['Cloud Beginners', 'Fresh Graduates', 'Non-IT to IT Career Switchers', 'Testing Professionals'],
      ...
      },
      {
        ...
        whoCanLearn: ['AWS Beginners with Basic Knowledge', 'Cloud Engineers', 'DevOps Beginners', 'System Administrators'],
      ...
      },
      {
        ...
        whoCanLearn: ['Java Developers', 'Full Stack Developers', 'Backend Developers', 'Cloud Developers'],
      ...
      },
      {
        ...
        whoCanLearn: ['System Administrators', 'Cloud Support Engineers', 'AWS Learners', 'DevOps Beginners'],
      ...
      },
      {
        ...
        whoCanLearn: ['DevOps Engineers', 'Cloud Engineers', 'AWS Administrators', 'Senior IT Professionals'],
      ...
      },
      {
        ...
        whoCanLearn: ['Cloud Engineers', 'Security Beginners', 'DevOps Engineers', 'System Administrators'],
    ...
    certifications: [
      {
        ...
        whoCanLearn: ['DevOps Beginners', 'Cloud Learners', 'Docker Beginners', 'Fresh Graduates'],
      ...
      },
      {
        ...
        whoCanLearn: ['DevOps Engineers', 'Cloud Engineers', 'System Administrators', 'Kubernetes Learners'],
      ...
      },
      {
        ...
        whoCanLearn: ['Developers', 'DevOps Engineers', 'Cloud Engineers', 'Application Deployment Learners'],
      ...
      },
      {
        ...
        whoCanLearn: ['Kubernetes Administrators', 'DevOps Security Engineers', 'Cloud Security Learners', 'Senior DevOps Engineers'],
    ...
    certifications: [
      {
        ...
        whoCanLearn: ['Data Analytics Beginners', 'Excel Users', 'Business Analysts', 'Reporting Professionals'],
      ...
      },
      {
        ...
        whoCanLearn: ['Data Beginners', 'Fresh Graduates', 'Cloud Beginners', 'Database Learners'],
      ...
      },
      {
        ...
        whoCanLearn: ['Data Engineers', 'Azure Learners', 'Data Analysts', 'Cloud Data Professionals'],
      ...
      },
      {
        ...
        whoCanLearn: ['Data Engineers', 'Google Cloud Learners', 'Cloud Data Professionals', 'Analytics Engineers'],
      ...
      },
      {
        ...
        whoCanLearn: ['AWS Learners', 'Data Engineers', 'Cloud Data Beginners', 'Analytics Professionals'],
    ...
    certifications: [
      {
        ...
        whoCanLearn: ['Scrum Beginners', 'QA Leads', 'Project Coordinators', 'Agile Team Members'],
      ...
      },
      {
        ...
        whoCanLearn: ['Product Owner Beginners', 'Business Analysts', 'Scrum Team Members', 'Project Professionals'],
      ...
      },
      {
        ...
        whoCanLearn: ['Agile Practitioners', 'Project Managers', 'Scrum Team Members', 'Delivery Leads'],
      ...
      },
      {
        ...
        whoCanLearn: ['Project Managers', 'Team Leads', 'Delivery Managers', 'Senior Professionals'],
